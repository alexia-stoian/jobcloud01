 ...
 * 
 * FORMAT: Plain text with underscore emphasis (_text_) for italics/emphasis.
 * No markdown syntax - renders cleanly in chat without parser.
 */
 ...
 * 
 * FORMATTING RULES:
 * - Use _underscores_ for emphasis instead of **bold** or *italics*
 * - No # markdown headers - use PLAIN TEXT with decorative lines
...
• _Drastically reduce emojis_ (maximum 0-1, very rare)
